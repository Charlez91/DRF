...
urlpatterns = [
    ...
    path("register/", core_views.RegisterAPIView.as_view(), name="user-registration"),
    path('api/docs/schema/', SpectacularAPIView.as_view(), name='schema'),
    path('', SpectacularSwaggerView.as_view(url_name='schema'), name='swagger-ui'),
    path('redoc/', SpectacularSwaggerView.as_view(url_name='schema'), name='swagger-redoc-ui'),
